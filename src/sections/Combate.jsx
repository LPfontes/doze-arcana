    ...
    return (
        <section id="sec-combate" className="content-section">
            ...
            <ul>
                ...
                <li><strong>Pontos de Vida (PV)</strong><br />Medem a saúde física. Calculado como <code>20 + (Fisico x 5)</code>. Ao chegar a 0 PV, o personagem fica Esgotado. Se sofrer qualquer tipo de dano enquanto estiver com 0 PV, ele sofre um Trauma (veja a tabela de traumas abaixo). Um personagem só pode ter no máximo 2 Traumas ativos antes de cair inconsciente; ao acumular o 3º Trauma, ele desmaia imediatamente.</li>
            ...
            <div className="bg-rose-50/30 border border-rose-200/60 rounded-xl p-5 mt-6 shadow-sm">
                ...
                <p className="text-xs text-gray-700 leading-relaxed mb-4">
                    Sempre que um personagem estiver com <strong>0 PV</strong> (Esgotado) e sofrer qualquer tipo de dano, ele deve rolar <strong>2d6</strong> e aplicar o trauma correspondente. Um personagem só pode ter no máximo 2 Traumas ativos antes de cair inconsciente (ao acumular o 3º Trauma, desmaia imediatamente):
                </p>
                    ...
                    <table className="w-full text-xs text-left border-collapse border border-rose-100/50">
                        ...
                        <tbody className="text-gray-700 font-sans">
                            <tr className="bg-rose-50/10">
                                ...
                                <td className="p-2.5 border border-rose-100">O personagem cai inconsciente, não pode agir e corre risco de morrer. Um personagem só volta a ficar consciente após ser estabilizado (PV acima de 0) e passar por um descanso longo.</td>
                            </tr>
                            <tr>
                                ...
                                <td className="p-2.5 border border-rose-100">O golpe deixa uma marca profunda. O limite máximo de PV do personagem é reduzido em <strong>3 PV</strong> permanentemente. A recuperação disso requer magias poderosas ou rituais arcanos a critério do narrador.</td>
                            </tr>
                            <tr>
                                ...
                                <td className="p-2.5 border border-rose-100">Sofre <strong>1 Desvantagem (-1d4)</strong> em todos os testes Mentais, de Iniciativa e na conjuração de magias até realizar um descanso longo.</td>
                            </tr>
                            <tr>
                                ...
                                <td className="p-2.5 border border-rose-100">Um membro é quebrado. Sofre <strong>1 Desvantagem (-1d4)</strong> em testes Físicos até ser tratado com medicina (Mental DT 10) ou magia de cura que cure pelo menos 5 PV.</td>
                            </tr>
                            <tr className="bg-rose-50/10">
                                ...
                                <td className="p-2.5 border border-rose-100">O personagem resiste bravamente (sem efeitos mecânicos negativos).</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <p className="mb-2">Todo personagem recebe <strong>(1 Ação de Movimento + 2 Ações Padrão) ou (1 Ação de Movimento + 1 Ação Complexa) ou 1 Ação Completa</strong> no início de seu turno. Além disso, todos têm direito a <strong>1 Reação por rodada</strong>.</p>
            <p className="mb-2"><strong>Exemplo:</strong></p>
            <p>Um aluno pode fazer um ataque básico usando uma <strong>Ação Padrão</strong> e em seguida fazer outra <strong>Ação Padrão</strong> para conjurar uma magia. Ou ele pode fazer um ataque básico usando uma <strong>Ação Padrão</strong> e em seguida fazer uma <strong>Ação de Movimento</strong> e atacar novamente usando outra <strong>Ação Padrão</strong>. Entretanto, a ação de movimento tem que ser resolvida antes de outras ações; não é possível se mover parte do movimento, fazer outra ação e depois mover o restante.</p>
            ...
            <p className="mb-2">Já a <strong>Ação Completa</strong> consome todo o tempo e movimento do turno, não sendo possível realizar nenhuma outra ação além da <strong>Ação Completa</strong>.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="bg-gray-50 p-4 rounded border border-gray-200">
                    ...
                    <ul className="mb-0 space-y-2">
                        ...
                        <li><strong>Ações Padrão (2 por turno):</strong><br />Realizar um ataque básico, conjurar um feitiço padrão ou realizar Testes Resistidos (Agarrar, Empurrar, Derrubar).</li>
                        <li><strong>Ação Complexa:</strong><br />Rituais complexos ou habilidades especiais que consomem ambas as Ações Padrão do turno (permitindo movimento).</li>
                    </ul>
                </div>
                <div className="bg-gray-50 p-4 rounded border border-gray-200">
