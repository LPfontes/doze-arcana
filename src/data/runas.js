...
export const FORMATOS_MISTICOS = [
    { id: 'toque', name: 'Toque ou Aura', cost: '0 PM', desc: 'A magia afeta você mesmo, ou uma criatura em alcance de toque corpo a corpo.' },
    { id: 'projetil', name: 'Projétil Mágico', cost: '1 PM', desc: 'A magia viaja como um projétil até atingir o alvo primário (Alcance Curto).' },
    { id: 'raio', name: 'Raio Contínuo', cost: '2 PM', desc: 'Um fluxo em linha reta. Pode atravessar e atingir até 2 alvos alinhados.' },
    { id: 'explosao', name: 'Explosão em Área', cost: '3 PM', desc: 'Atinge um espaço em Área Pequena (3x3). Todos no raio são afetados.' }
];
...
export const RUNES_BY_GRAU = {
    grau1: {
        ...
        conditionRunes: [
            { id: 'fogo', name: 'Queimadura', cost: '2 PM', type: 'Debuff', test: 'Físico Agilidade', succ: 'sofre apenas 3 de dano de fogo.', desc: 'Falha: As chamas grudam no alvo. No início dos próximos 2 turnos dele, ele sofre 1d6 de dano direto (ignora PR).', scale: '+2 PM: Aumenta a duração da condição em +1 Rodada.' },
            { id: 'agua', name: 'Hipotermia', cost: '2 PM', type: 'Debuff', test: 'Físico Vigor', time: '1 Rodada', succ: 'sofre 1 Desvantagem (-1d6) no próximo turno.', desc: 'Falha: Frio nos ossos. O inimigo perde 1 de suas Ações Padrões no seu próximo turno (recebendo apenas 1 Ação de Movimento e 1 Ação Padrão).', scale: '+2 PM: O alvo também recebe 1 Desvantagem. / +4 PM (Congelamento Profundo): O alvo fica Congelado e perde todo o seu próximo turno.' },
            { id: 'terra', name: 'Tremor', cost: '2 PM', type: 'Condição', test: 'Físico Agilidade', succ: 'movimento reduzido pela metade.', desc: 'Falha: Pedras e raízes restringem o alvo. Ele fica Impedido até o final do seu próximo turno.', scale: '+2 PM: O alvo sofre 1d6 de dano contundente no início do turno se tentar se mover.' },
            { id: 'vento', name: 'Lufada', cost: '2 PM', type: 'Movimento', test: 'Físico Agilidade', succ: 'Fica apenas Derrubado no mesmo lugar.', desc: 'Falha: Uma lufada empurra o alvo em até 4 Espaços em qualquer direção. Sofre 3 de dano extra se colidir com obstáculos/inimigos.', scale: '+1 PM: Empurra o alvo +2 Espaços adicionais.' }
        ],
        modifiers: [
            { id: 'ataque', name: 'Runa de Ataque', cost: '+1 PM', desc: 'Causa 3 + 1d6 + seu atributo de Magia em Dano. Você pode gastar múltiplos de +3 PM extras para adicionar +1d6 de dano e +1 DT.' }
        ],
        customRunes: [
            {
                element: ' Fogo',
                ...
                runes: [
                    { name: 'Derretimento', cost: '+3 PM', type: 'Debuff', test: 'Físico Vigor', desc: 'Falha: perde 2 Pontos de Redução de Dano (RD) por 1 Rodada.' },
            ...
            },
            {
                ...
                runes: [
                    ...
                    { name: 'Congelamento', cost: '+3 PM', type: 'Debuff', test: 'Físico Vigor', time: '1 Rodada', desc: 'Falha: A Redução de Dano (RD) do alvo cai para 0 apenas contra o próximo ataque físico que ele receber.' },
            ...
            },
            {
                ...
                runes: [
                    ...
                    { name: 'Corte', cost: '+1 PM', type: 'Efeito', test: 'Físico Destreza', time: 'Imediato', desc: 'Falha: Sopro afiado que causa 1 ponto de dano cortante a um alvo em alcance curto. Não requer munição e é ideal para cortar cordas finas, fitas ou papéis.' }
                ]
            },
            {
                element: 'Vida',
                ...
                runes: [
                    { name: 'Curar', cost: '+2 PM', type: 'Utilidade', time: 'Imediato', desc: 'Cura 1d6 PV em um alvo em alcance curto.', scale: '+2 PM: Cura +1d6 PV adicionais.' },
    ...
    grau2: {
        ...
        conditionRunes: [
            { id: 'luz', name: 'Ofuscamento', cost: '3 PM', type: 'Debuff', test: 'Físico Vigor', time: '1 Rodada', succ: 'não fica cego mas ataques contra ele têm +1 Vantagem até seu próximo turno.', desc: 'Falha: Clarão queima as retinas. O alvo fica Cego até o fim do próximo turno, e +1 Vantagem para ataques contra ele até o final do seu próximo turno.' },
            { id: 'vida', name: 'Sifão', cost: '3 PM', type: 'Efeito', test: 'Físico Vigor', succ: 'alvo sofre apenas metade do dano.', desc: 'Falha: Rouba a centelha vital. Metade de todo o dano causado aos PVs do alvo é imediatamente revertido como cura para o conjurador ou um aliado adjacente.' },
            { id: 'vinculo', name: 'Marca', cost: '3 PM', type: 'Debuff', test: 'Magia Controle', succ: 'sofre apenas 3 de dano.', desc: 'Falha: Fios de mana se prendem. Todos os ataques contra este inimigo recebem +1 Vantagem (+1d6) e +2 de dano bônus.' },
            { id: 'isolamento', name: 'Prisão', cost: '4 PM', type: 'Debuff', test: 'Mental Vontade', time: '1 Rodada', succ: 'sofre apenas 3 de dano.', desc: 'Falha: Espaço endurece como vidro. Ele fica Imobilizado, não pode ser curado ou receber buffs de aliados até o final do seu próximo turno.' },
            { id: 'escuridao', name: 'Terror', cost: '4 PM', type: 'Debuff', test: 'Mental Vontade', time: '1 Rodada', succ: 'sofre 1 desvantagem neste turno.', desc: 'Falha: Alvo fica cego e surdo, recebe desvantagem em ataques e fica impedido de conjurar magias até o final do seu próximo turno.' }
        ],
        modifiers: [
            { id: 'alcance_expandido', name: 'Alcance Expandido', cost: '+2 PM', desc: 'Sobe o alcance do feitiço em 1 Categoria. Um feitiço Toque vira Curto (6 Espaços). Um Curto vira Médio (12 Espaços). Um Médio vira Longo (24 Espaços).' },
            { id: 'area_expandida', name: 'Área Expandida', cost: '+2 PM', desc: 'Sobe o tamanho da área do feitiço em 1 Categoria. Um alvo único vira Pequena (3x3). Uma Pequena vira Média (6x6). Média vira Grande (9x9).' },
    ...
    grau3: {
        ...
        conditionRunes: [
            { id: 'ordem', name: 'Supressão', cost: '3 PM', type: 'Debuff', test: 'Magia Controle', succ: 'Não perde Reações mas movimento é reduzido pela metade por 1 turno.', desc: 'Falha: A gravidade do cosmos esmaga a iniciativa do alvo. Ele perde todas as suas Reações e seu movimento é reduzido a 0 pelos próximos 2 turnos.' },
            { id: 'caos', name: 'Desorientação Mágica', cost: '3 PM', type: 'Debuff', test: 'Magia Controle', succ: 'o alvo sofre 1 desvantagem neste turno.', desc: 'Falha: Provoca oscilações de probabilidade. No próximo turno do alvo, a primeira magia que conjurar custa o dobro de PM. Se não puder pagar, ela falha catastroficamente.' },
            { id: 'vazio', name: 'Exaustão', cost: '3 PM', type: 'Condição', test: 'Mental Vontade', time: '1 Rodada', succ: 'sofre apenas 3 de dano.', desc: 'Falha: Drena a energia existencial. O inimigo contrai a condição Debilitado, reduzindo drasticamente seus atributos físicos.' }
        ],
        modifiers: [
